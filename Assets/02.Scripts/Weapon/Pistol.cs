...
public class Pistol : BaseFirearm
{
        ...
        if (CurrentAmmo > 0)
        {
            ...
            if (FireElapsedTime >= FireCoolTime)
            {
                ...
                else
                {
                    ...
                    trail.Initialize(FirePosition.transform.position - new Vector3(0f, 0.5f, 0f), FirePosition.transform.position + finalDireciton.normalized * 30f);
                }
